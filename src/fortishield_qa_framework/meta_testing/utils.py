...
CUSTOM_PATTERN = 'fortishield-modulesd:aws-s3: INFO: Executing Service Analysis'
CUSTOM_REGEX = r'.*fortishield-modulesd:aws-s3: INFO: Executing Service Analysis'
DEFAULT_LOG_MESSAGE = '2023/02/14 09:49:47 fortishield-modulesd:aws-s3: INFO: Executing Service Analysis'
