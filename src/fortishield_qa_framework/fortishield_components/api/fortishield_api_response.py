"""
Module to wrapp the Fortishield API responses. This modules contains the following:

- FortishieldAPIResponse
"""
from http import HTTPStatus
from json import JSONDecodeError


class FortishieldAPIResponse:
    """Wrapper class to handle Fortishield API responses.
    ...
    Attributes:
        ...
        error (int): Fortishield API response error.
        data (dict|str): Fortishield API response data in dict format if possible else string.
    """
    ...
    def __get_data(self):
        ...
        Returns:
            (dict|str):  Fortishield API response data in dict format if possible else string.
        """
